angular.module('lasso-location-client.services', [])

.factory('Geofence',['$rootScope',function($rootScope){

}])
.factory('Geolocation',['$rootScope','$q','$cordovaGeolocation',
...
.factory('Map',['$rootScope',function($rootScope){
  var map = null;
  var markers = [];
